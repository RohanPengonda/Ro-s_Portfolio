  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "rohan.pengonda@email.com",
      link: "mailto:rohan.pengonda@email.com"
    },
    {
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  and ways to contribute to exciting teams. Feel free to reach out through 
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <a
                    key={index}
                    href={info.link}
                    className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors duration-300 group"
                  >
